...
class YOLOV3Loss(gluon.loss.Loss):
    ...
    """
    def __init__(self, batch_axis=0, weight=None, deg=8, **kwargs):
    ...
    def hybrid_forward(self, F, objness, box_centers, box_scales, coef_center, coef, cls_preds,
                       objness_t, center_t, scale_t, coef_center_t, coef_t, weight_t, class_t, class_mask):
        ...
        coef_loss = F.broadcast_mul(self._l1_loss(coef, coef_t, coef_weight_t), denorm * (2*self._deg+2))
        denorm_class = F.cast(
        ...
        return obj_loss, center_loss, scale_loss, coef_center_loss, coef_loss, cls_loss
